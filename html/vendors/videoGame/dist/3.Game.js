...
regaloNavidad.Game.prototype = {
    ...
    generateObjects: function() {
        ...
        var enemy;
        var numberOfEnemy;
        var numEnemy = this.game.rnd.integerInRange(3, 7);
        for (var i = 0; i < numEnemy; i++) {
            ...
            switch(numberOfEnemy){
                case 1:
                    this.tryNotOverlap(450, numberOfEnemy);
                break;
                case 2:
                    this.tryNotOverlap(540, numberOfEnemy);
                break;
                case 3:
                    this.tryNotOverlap(500, numberOfEnemy);
                break;
                case 4:
                    this.tryNotOverlap(493, numberOfEnemy);
                break;
                case 5:
                    this.tryNotOverlap(450, numberOfEnemy);
                break;
                case 6:
                    this.tryNotOverlap(430, numberOfEnemy);
                break;
                case 7:
                    this.tryNotOverlap(420, numberOfEnemy);
                break;
            }
        }
    },
    tryNotOverlap: function(posY, enemyNumber) {
        ...
        for (var i = 0; i < len; i++) {
            if(i > 0){
                posiblesErrores = 0;
                while(this.game.physics.arcade.overlap(this.objects.children[i],this.objects.children[i-1])) {
